    ...
    public partial class Form1 : Form
    {
        ...
        public void MyControlButtonClick(object sender, EventArgs e)
        {
            if (sender.GetType().ToString() == "System.Windows.Forms.Button")
            {
                ...
                {
                    fileRW file = new fileRW(bt.Text, this);
                    file.Show();
                }
            ...
            else
            {
                ...
                if(((ToolStripMenuItem)sender).Name== "打开ToolStripMenuItem")
                {
                    if (type == "0") //文件
                    {
                        fileRW file = new fileRW(filename, this);
                        file.Show();
                    }
                    else if (type == "1")//文件夹
                    {
        ...
        {
            string str = Interaction.InputBox("请输入文件的名称", "文件命名", "", -1, -1);
            if (str != "")
            {
        ...
        {
            string str = Interaction.InputBox("请输入文件夹的名称", "文件夹命名", "", -1, -1);
            if (str != "")
            {
            ...
            if (searchStr != "" && searchStr != null)
            {
                ...
                if (name.Length > 4)
                {
                    ...
                    if (folderOrFile == ".txt")  //文件
                    {
                        ...
                        if (cur != null)
                        {
                            fileRW file = new fileRW(cur.fcb.fileName, this);
                            file.Show();
                        }
                        else
                        {
        ...
        private void treeView_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {
                fileRW file = new fileRW(tn.Text.Replace(".txt", ""), this);
                file.Show();
            }
        }
        //递归查找往目录树中加入结点，两个函数
        ...
        private void modifyTime_Click(object sender, EventArgs e)
        {
        ...
        private void labelDiskSize_Click(object sender, EventArgs e)
        {

        }

        private void labelBlockSize_Click(object sender, EventArgs e)
        {
